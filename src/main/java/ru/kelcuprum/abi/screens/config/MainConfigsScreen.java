...
public class MainConfigsScreen {
    ...
    public Screen build(Screen parent){
        ...
        return new ConfigScreenBuilder(parent, Component.translatable("abi.name"), designType)
                ...
                .addWidget(new ButtonConfigBoolean(140, 80, designType, AlinLib.bariumConfig, "LOCALIZATION.EXTENDED_COORDINATES", false, Component.translatable("alinlib.config.localization.extended_coordinates")))
