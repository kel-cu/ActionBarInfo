...
public class ModulesScreen {
    public static Screen build(Screen parent){
        ConfigScreenBuilder builder =  new ConfigScreenBuilder(parent, Component.translatable("abi.name"))
                .addPanelWidget(new ButtonBuilder(Component.translatable("abi.configs")).setCentered(false).setOnPress((s) -> AlinLib.MINECRAFT.setScreenAndShow(MainConfigsScreen.build(parent))).setIcon(OPTIONS))
                .addPanelWidget(new ButtonBuilder(Component.translatable("abi.modules")).setCentered(false).setOnPress((s) -> AlinLib.MINECRAFT.setScreenAndShow(build(parent))).setIcon(MODULES))
